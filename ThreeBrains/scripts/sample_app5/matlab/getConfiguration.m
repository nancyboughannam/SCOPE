...
function [ret_val] = getConfiguration(argType)
    if(argType == 1)
        ret_val = '/Users/nancyboughannam/Documents/ThreeBrains/sim_results/';
    elseif(argType == 2)
    ...
    elseif(argType == 5)
        ret_val = {'RT_OPT_ML','EXP3_MC','RAIDER_TRAX','RANDOM'};
    elseif(argType == 6)
        ret_val = {'SCOPE','EXP3-MC-adapted','RAIDER-TRAX','RANDOM'};
    elseif(argType == 7)
