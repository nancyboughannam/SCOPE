 ...
 *
 * <p>
 * SimUtils contains a collection of static utility methods that support various
 * simulation operations including random number generation, file system
 * management, and time calculations. These utilities are designed to be
 * lightweight, thread-safe, and commonly needed across different simulation
 * components.</p>
 *
 * <p>
 * <b>Key Functionality Areas:</b>
 * <ul>
 * <li><b>Random Number Generation:</b> Uniform distribution sampling for
 * various data types</li>
 * <li><b>File System Operations:</b> Output directory management and
 * cleanup</li>
 * <li><b>Time Calculations:</b> Human-readable duration formatting and
 * conversions</li>
 * </ul></p>
 *
 * <p>
 * All methods are static and thread-safe, making them suitable for use in
 * multi-threaded simulation environments. The random number generator is seeded
 * with the current system time to ensure different sequences across simulation
 * runs.</p>
 *
...
public class SimUtils {
     ...
     *
     * <p>
     * Uses system time as seed to ensure different random sequences across
     * simulation runs while maintaining reproducibility within a single
     * simulation execution.</p>
     */
//	public static final Random RNG = new Random(System.currentTimeMillis());


// ===== FIXED RANDOM SEED CHANGE START =====
    public static final Random RNG = new Random(20260828L);

    public static void setSeed(long seed) {
        RNG.setSeed(seed);
    }
// ===== FIXED RANDOM SEED CHANGE END =====
     ...
     *
     * <p>
     * Uses uniform distribution to select a random integer from the closed
     ...
     * device ID selection, task type assignment, and configuration
     * indexing.</p>
     *
     ...
     *
     * <p>
     * Uses uniform distribution to select a random double from the closed
     * interval [start, end]. Suitable for continuous value generation such as
     * timing parameters, geographical coordinates, and probability
     * thresholds.</p>
     *
     * @param start the minimum value (inclusive)
     * @param end the maximum value (inclusive)
     ...
     *
     * <p>
     * Uses uniform distribution to select a random long from the closed
     * interval [start, end]. Useful for large-scale simulations requiring
     * high-precision identifiers or when dealing with large numerical
     * ranges.</p>
     *
     * @param start the minimum value (inclusive)
     * @param end the maximum value (inclusive)
     ...
     *
     * <p>
     * This method ensures a clean state for simulation output by removing any
     * existing result files from previous simulation runs. It performs
     * validation to ensure the target directory exists and is accessible before
     * attempting cleanup operations.</p>
     *
     * <p>
     * <b>Safety Features:</b>
     * <ul>
     ...
     *
     * <p>
     * <b>Warning:</b> This method will permanently delete all files in the
     ...
     * @throws System.exit(1) if directory is inaccessible or file deletion
     * fails
     */
    ...
    /**
     * Calculates and formats the time difference between two dates in
     * human-readable form.
     *
     * <p>
     * Converts the duration between start and end dates into a comprehensive
     * string representation showing days, hours, minutes, seconds, and
     * milliseconds as appropriate. The output format is designed for logging
     * and user-friendly simulation progress reporting.</p>
     *
     * <p>
     * <b>Output Format Examples:</b>
     * <ul>
     ...
     *
     * <p>
     * The method uses proper pluralization and only includes non-zero time
     * units in the output. For durations less than one second, milliseconds are
     * shown to provide precise timing information for performance analysis.</p>
     *
